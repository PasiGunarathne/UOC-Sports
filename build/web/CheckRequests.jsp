...
<ol class="breadcrumb">
    ...
    <li class="breadcrumb-item active">Check booking Requests</li>
</ol>
...
//                PrintWriter out = response.getWriter();
                ...
                String str = "<table><tr><th><p>Subject</p></th>"
                        + "<th><p>|</p></th>"
                        + "<th><p>Request ID</p></th>"
                        + "<th><p>Request Person</p></th>"
                        + "<th><p>E-mail</p></th>"
                        + "<th><p>Contact no</p></th>"
                        + "<th><p>Request Details</p></th>"
                        + "<th><p>Sport</p></th>"
                        + "<th><p>Date</p></th>"
                        + "<th><p>Desciption</p></th>"
                        + " </tr>";
